...
| *`cacheSyncTimeout`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.30/#duration-v1-meta[$$Duration$$]__ | CacheSyncTimeout defines the maximum time to wait for the initial sync of the context and trigger caches to complete. +
