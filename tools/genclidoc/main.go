...
var autoGeneratedLineRegexp = regexp.MustCompile(`(?m)^(###### Auto generated by spf13/cobra) on .*$`)
...
func main() {
	...
	for _, file := range files {
		...
		// Remove the date from the auto-generated line
		raw = autoGeneratedLineRegexp.ReplaceAll(raw, []byte("$1"))
