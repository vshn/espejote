...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContextPlugin) DeepCopyInto(out *ContextPlugin) {
	*out = *in
	if in.Data != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContextPlugin.
func (in *ContextPlugin) DeepCopy() *ContextPlugin {
	if in == nil {
		return nil
	}
	out := new(ContextPlugin)
	in.DeepCopyInto(out)
	return out
}
